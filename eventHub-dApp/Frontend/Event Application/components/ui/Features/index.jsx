    ...
    const features = [
        {
            ...
            title: "Best quality",
            desc: "Event Hub is popular for Organizing quality events. As a digital product development agency, we believe in beautiful software and outcomes."
        },
        {
            icon:
            ...
            desc: "We use the modern and most flexible and secure technologies to build the best and streamline the organizing event on the internet."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
