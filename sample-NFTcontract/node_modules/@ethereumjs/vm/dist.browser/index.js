        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (!!this._opts.stateManager) return [3 /*break*/, 7];
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        if (!this._opts.activatePrecompiles) return [3 /*break*/, 7];
                    ...
                    case 6:
                        ...
                        _a.label = 7;
                    case 7:
                        if (!this._common.isActivatedEIP(2537)) return [3 /*break*/, 10];
                        if (!isBrowser()) return [3 /*break*/, 8];
                        throw new Error('EIP-2537 is currently not supported in browsers');
                    case 8:
                        mcl_1 = this._mcl;
