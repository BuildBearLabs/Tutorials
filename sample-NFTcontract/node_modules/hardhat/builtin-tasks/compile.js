...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_COMPILE_JOBS)
    ...
    const pMapOptions = { concurrency: os_1.default.cpus().length, stopOnError: false };
    try {
        ...
        const artifactsEmittedPerJob = results.map(({ compilationJob, artifactsEmittedPerFile }) => ({
            compilationJob,
