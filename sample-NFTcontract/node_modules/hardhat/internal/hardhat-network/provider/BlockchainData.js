...
class BlockchainData {
    ...
    reserveBlocks(first, count, interval, previousBlockStateRoot, previousBlockTotalDifficulty) {
        const reservation = {
            first,
    ...
    fulfillBlockReservation(blockNumber) {
        ...
        (0, errors_1.assertHardhatInvariant)(reservationIndex !== -1, `No reservation to fill for block number ${blockNumber}`);
