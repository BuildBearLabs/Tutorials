...
contract UnilendFlashLoanReceiverBase {
    ...
    address payable public unilendFlashLoanCore = payable(0x207Cb7aEb640fA6CEe696269dEe1A441D0425a3d);
    ...
    function flashLoan(address _target, address _asset, uint256 _amount, bytes memory _params) internal {
        IUnilendFlashLoanCoreBase(unilendFlashLoanCore).flashLoan(_target, _asset, _amount, _params);
    }
