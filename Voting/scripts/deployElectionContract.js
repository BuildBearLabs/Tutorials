...
const mainContractAddress =
  require('../deployments/buildbear/MainContract.json').address
...
async function main () {
  ...
  const newElectionTransaction = await maincontract.createElection(
    ['class leader election', 'to select the class leader'],
    ['Chandan', 'Rahul', 'Micky']
  )
